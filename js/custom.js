...
ScrollReveal().reveal('.skill2', { duration: 1000, rotate: { x: 20, z: 20 }, delay: 600 })
ScrollReveal().reveal('.skill3', { duration: 1000, rotate: { x: 20, z: 20 }, delay: 800 })
ScrollReveal().reveal('.skill4', { duration: 1000, rotate: { x: 20, z: 20 }, delay: 1000 })
ScrollReveal().reveal('.skill5', { duration: 1000, rotate: { x: 20, z: 20 }, delay: 1200 })
ScrollReveal().reveal('.skill6', { duration: 1000, rotate: { x: 20, z: 20 }, delay: 1400 })
ScrollReveal().reveal('.skill7', { duration: 1000, rotate: { x: 20, z: 20 }, delay: 1600 })
ScrollReveal().reveal('.skill8', { duration: 1000, rotate: { x: 20, z: 20 }, delay: 1800 })
ScrollReveal().reveal('.skill9', { duration: 1000, rotate: { x: 20, z: 20 }, delay: 2000 })
ScrollReveal().reveal('.skill10', { duration: 1000, rotate: { x: 20, z: 20 }, delay: 2200 })
