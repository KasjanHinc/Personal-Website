...
const Navbar = (props) => {
  ...
  // STOP PULSE OF HAMBURGER WHEN CLICKED
  function stopPulse() {
  ...
  return (
    ...
    <nav className="navbar navbar-dark nav-background fixed-top">
      ...
      {/* CURSOR DIVS FOR THE CUSTOM CURSOR */}
      <div className="cursor"></div>
      <div className="cursor"></div>

      <Fade>

        <button className="dark-mode-toggler" name="dark mode toggle" onClick={darkMode.toggle}>{darkMode.value ? moon : sun}</button>

        <a id="social-linkedin" href="https://www.linkedin.com/in/kasjan-hinc/" rel="noreferrer" name="linkedin link" target="_blank">{linkedin}</a>

        <a id="social-github" href="https://github.com/KasjanHinc" rel="noreferrer" name="github link" target="_blank">{github}</a>

        <a id="social-fiverr" href="https://www.fiverr.com/kasjan" rel="noreferrer" name="fiverr link" target="_blank">
        ...
        <button onClick={stopPulse} className={togglerPulse ? 'navbar-toggler ml-auto' : 'navbar-toggler ml-auto navbar-toggler-stop'} type="button" name="hamburger menu" data-toggle="collapse" data-target="#navbarResponsive">
